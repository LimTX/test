...
<p>HOME &gt; ADMIN PANEL &gt; CATEGORIES &gt; ADD CATEGORY</p>
   <h1>Categories</h1>
   <br />
      <p>This section allows you to create new Category.</p>    
    <h3>Add Category</h3>
        <br />
    <p class="orange"><?php $session->flash(); ?></p>
    
<?php
echo $form->create('Category', array('class'=>'cmxform','id'=>'form2','type' => 'file'));
?>
