...
<p>HOME &gt; ADMIN PANEL &gt; SUB-CATEGORIES &gt; ADD SUB-CATEGORY</p>
   <h1>Categories</h1>
   <br />
...
<?php
echo $form->create(null, array('url' => array('controller' => 'categories', 'action' => 'subcategories_add'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
?>
...
<td>
<?php echo $form->file('Image.name1', array('size' => '40','validate' => 'accept:"jpg|jpeg|png|gif"','error'=>true)); ?>
<?php if($form->isFieldError('image')) {
