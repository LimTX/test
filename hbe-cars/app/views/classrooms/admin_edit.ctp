...
<h4 class="alert_info">This section allows you to edit a Classroom record.</h4>
...
<?php
echo $form->create(null, array('url' => array('controller' => 'Classrooms', 'action' => 'edit'),'class'=>'cmxform','id'=>'form2'));
?>	
    ...
    <td>
    <?php 
	echo $form->input('school_id', array('type' => 'select','label' => false,'style'=>'width:254px;', 'options' => $schools,'validate'=>'required:true','div'=>'formfield'));
	?>
    </td>
    </tr>
    <?php } ?>
    ...
    <br/>
    Please refer to the examples below to edit a class.
   	<br/><br/>
