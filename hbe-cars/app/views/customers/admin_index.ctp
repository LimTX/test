...
<?php $session->flash(); ?>
<br /><br />
<h4 class="alert_info">This section allows you to create a new Student, or edit or delete an existing ones.</h4>
...
<div style="height:40px; display:inline-block; padding-top:19px; vertical-align:middle;">	<?php 

echo $html->link( $text->truncate($customer['Customer']['customers_firstname']." ".$customer['Customer']['customers_lastname'],
    20,
    ' ...',
    false
    ),
...
//echo $html->link('Edit', array('action'=>'edit', 'id'=>$category['Category']['id'])); ?>
    ...
    <?php
		...
		<br /> There are currently no student records.<br/><br/></p>";
    }
    ?>
