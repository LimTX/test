...
<?php $session->flash(); ?>
<br /><br />
<h4 class="alert_info">This section allows you to create new Teacher, edit or delete existing ones.</h4>
   ...
   <br/><br/>
    ...
    <?php
       ...
       echo "<p style='margin-left:20px;'>
		...
		<br /> Your search <strong>'"." "."'</strong> did not match any Teacher records. <br/><br/></p>";	
		...
		<br /> Your search <strong>'".$this->params['url']['search_text']."'</strong> did not match any Teacher records. <br/><br/></p>";
    } }
    ?>
