   <div id="googlemap" style="margin-left:10px;">
	<?php if(!empty($product[0]['Product']['location'])) { ?>
    <p><strong>Location</strong></p>
    <p><?php echo $product[0]['Product']['location']?></p>
    <br />
    <?php } ?>
     <?php if(!empty($product[0]['Product']['how_to_get_there'])) { ?>
    <p><strong>How To Get There</strong></p>
    <p><?php echo $product[0]['Product']['how_to_get_there']?></p>
        <br />
    <?php } ?>
   <p><strong>Map</strong>
    <br />
...
$MAP_OBJECT->addMarkerByAddress($product[0]['Product']['location'],"", $product[0]['Product']['name']);
?>
