<!doctype html>
<head>
  <title>Your Page Was Not Found</title>
  	<?php echo $html->css('reset'); ?>
    <?php echo $html->css('layout'); ?>
    <?php echo $html->meta('icon', $html->url('/mac-icon.png')); ?>
    ...
    <?php } ?>
       ...
       <?php } ?>
		...
		<ul class="toggle">
            ...
            <?php echo ""; ?>
            <?php } else { ?>
          <li class="icn_resume_article"><?php echo $html->link('Continue Assessment', $resumetest); ?></li>
            <?php } ?>
...
<?php } ?>
    ...
    <div class="col" id="section-right">
        <div id="dashboard">
            <div id="sub-header">
              <?php echo $html->image('icon-dashboard.png', array('alt' => 'Dashboard','style' => 'vertical-align:text-bottom;'))?> Assessment and Reports &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h2>
            </div>
        </div>
        ...
        <div id="breadcrumbs">
            <div id="breadcrumb-trail">
			 ...
			 <article class="breadcrumbs">
				<?php echo "<a class='current'>Your page was not found.</a>"; ?>         
             </article>
             <?php
			 if ($admin != 'superadmin') {
			 ...
			 if ($exp < 8) {
				...
				header("Location: http://localhost:8888/hbe-cars/customers/logout");
					...
					header("Location: http://carsandstars.com.au/customers/logout");
					 ...
					 echo "<a href='#' style=\"color:#E42217;\">Your subscription will going to expire in ".$exp." days</a>";
					 echo '</article>';
				 } else {
					 echo '<article class="breadcrumbs" style="float:right;">'; 
					 echo "<a href='#' style=\"color:#E42217;\">Your subscription will going to expire in ".$exp." day</a>";
					 echo '</article>';	 
				 }
