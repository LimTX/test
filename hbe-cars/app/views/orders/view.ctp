...
<?php     
  ...
  <td width="75">
  <?php echo $form->input('Cart.qty', array( 'name'=>'data['.$cartContent['ct']['id']. ']', 'type'=>'text', 'label'=>null, 'onKeyUp'=>'checkNumber(this);', 'value'=>$cartContent['ct']['qty'] ) );?>
...
<table width="550" border="0" align="center" cellpadding="10" cellspacing="0">
 <tr align="center"> 
  ...
  <td>
  <?php echo $form->button('Proceed To Checkout', array( 'class'=>'box' , 'onClick'=>"window.location.href='".$this->base."/carts/checkout/pd_id:".$cartContent['ct']['product_id']."'" ) ) ;?>    
  </td>
 </tr>
</table>