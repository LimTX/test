...
<?php echo $form->input('search_suburb', array('options' => $suburb, 'empty' => '-- Select Location --','label' => false,'id' => 'd','div'=>'aaa')); ?>
<div style="width:5px; height:5px; float:right;"></div><?php echo $form->input('search_category', array('options' => $categories,'type'=>'select','empty' => '-- Select Category --','label' => false,'id' => 'd','div'=>'aaa')); ?>
<br clear="all" />
<br />
    <div id="plus"></div>
    ...
    <thead>
    	<tr>
            <th width="55%" scope="col"><?php echo $paginator->sort('Name', 'name', array('title' => 'Sorting Title Alphabetically','class' => 'normalTip')); ?></th>
            ...
            <th class="featuredtable" width="5%" scope="col">Featured</th>
    ...
    <td class="featuredtable" width="5%" align="center"><p>
	<?php if($product['Product']['featured'] == 1) { ?>
   
    <?php echo $html->image("featured.png", array());
	
	} else {
	
	echo $html->image("disabled.png", array());
