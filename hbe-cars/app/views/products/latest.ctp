...
<p>HOME &gt; <span style="text-transform:uppercase;">Latest Offers</span></p>
<div class="titleBar" style="padding-top:10px;">

   <h1 style="font-size:28px;">Latest Offers</h1>
</div>
<?php
    if(isset($products) && !empty($products)) {
				
       ?><br />
             <div style="padding-bottom:5px;"> <p>This section allows you to view a list of latest offers.</p></div>
