...
<h4 class="alert_info">This section allows you to create new a School record.</h4>
...
<?php
echo $form->create(null, array('url' => array('controller' => 'schools', 'action' => 'add'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
?>	
    ...
    <td>
   <?php 
    echo $form->input('School.accessright',array('label' => false,'validate' => 'required:true','div'=>'formfield')); 
    ?>
    </td>
    </tr>
    <tr>
   ...
   echo $form->input('School.teacher_carscombo', array('type' => 'select','empty' => '-- Select --','label' => false,'style'=>'width:254px;', 'options' => $options,'validate'=>'required:true','div'=>'formfield')); ?>
    </td>
    </tr>
    <tr>
   ...
   echo $form->input('School.teacher_focus', array('type' => 'select','empty' => '-- Select --','label' => false,'style'=>'width:254px;', 'options' => $options,'validate'=>'required:true','div'=>'formfield')); ?>
    </td>
    </tr>
     <tr>
