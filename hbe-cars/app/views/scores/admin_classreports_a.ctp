...
<?php if ($glessontotal1 != 0) { $glesson1 = $MIGraphResp1 + $FDGraphResp1 + $USGraphResp1 + $CEGraphResp1 + $MPGraphResp1 + $WMGraphResp1 + $CIGraphResp1 + $RPGraphResp1; echo $glesson1total = round($glesson1 / $glessontotal1, 2) / 0.01; } else { echo $glesson1total = 0 ; } ?>,
     ...
     <?php 	$lessonid = $i;
		...
		<div class="tab_container">
            ...
            <tr> 
                    ...
                    <th class="header"><?php echo $html->link('MI', '#', array('title' => 'Finding Main Idea',"style"=> 'font-size:10px;')); ?></th> 
    				<th class="header"><?php echo $html->link('FD', '#', array('title' => 'Recalling Facts and Details',"style"=> 'font-size:10px;')); ?></th> 
                    <th class="header"><?php echo $html->link('US', '#', array('title' => 'Understanding Sequence',"style"=> 'font-size:10px;')); ?></th> 
                    <th class="header"><?php echo $html->link('CE', '#', array('title' => 'Recognising Cause and Effect',"style"=> 'font-size:10px;')); ?></th>
                    <th class="header"><?php echo $html->link('MP', '#', array('title' => 'Making Predictions',"style"=> 'font-size:10px;')); ?></th>
                    <th class="header"><?php echo $html->link('WM', '#', array('title' => 'Finding Word Meaning in Context',"style"=> 'font-size:10px;')); ?></th>
                    <th class="header"><?php echo $html->link('CI', '#', array('title' => 'Drawing Conclusions and Making Inferences',"style"=> 'font-size:10px;')); ?></th>
                    <th class="header"><?php echo $html->link('RP', '#', array('title' => 'Reading Pictures',"style"=> 'font-size:10px;')); ?></th>
				</tr>
              </thead>
              <tbody> 
