    ...
    $(document).ready(function() {	   				
       chart2 = new Highcharts.Chart({
         ...
         series: [{
            name: "Lesson",
			<?php //CHECK THE NO. OF QUESTION FOR EACH BOOK ?>
            data: [<?php echo $glesson1total ?>,<?php echo $glesson2total ?>,<?php echo $glesson3total ?>,<?php echo $glesson4total ?>,<?php echo $glesson5total ?>,<?php echo $glesson6total ?>,<?php echo $glesson7total ?>,<?php echo $glesson8total ?>,<?php echo $glesson9total ?>,<?php echo $glesson10total ?>,<?php echo $gaverage ?>
			],
			threshold: 0,
			dataLabels: {
            enabled: true,
     ...
     <?php 	$lessonid = $i;
		...
		<div class="tab_container">
            ...
            <tr> 
    				...
    				<th class="header"><?php echo $html->link('MI', '#', array('title' => 'Finding Main Idea',"style"=> 'font-size:10px;color:#333;')); ?></th> 
    				<th class="header"><?php echo $html->link('FD', '#', array('title' => 'Finding Details',"style"=> 'font-size:10px;color:#333;')); ?></th> 
                    <th class="header"><?php echo $html->link('US', '#', array('title' => 'Understanding Sequence',"style"=> 'font-size:10px;color:#333;')); ?></th> 
                    <th class="header"><?php echo $html->link('CE', '#', array('title' => 'Recognising Cause and Effect',"style"=> 'font-size:10px;color:#333;')); ?></th>
                     <th class="header"><?php echo $html->link('CC', '#', array('title' => 'Comparing and Constrasting',"style"=> 'font-size:10px;color:#333;')); ?></th>
                    <th class="header"><?php echo $html->link('MP', '#', array('title' => 'Making Predictions',"style"=> 'font-size:10px;color:#333;')); ?></th>
                    <th class="header"><?php echo $html->link('WM', '#', array('title' => 'Finding Word Meaning in Context',"style"=> 'font-size:10px;color:#333;')); ?></th>
                    <th class="header"><?php echo $html->link('CI', '#', array('title' => 'Drawing Conclusions and Making Inferences',"style"=> 'font-size:10px;color:#333;')); ?></th>
                    <th class="header"><?php echo $html->link('FO', '#', array('title' => 'Distinguishing Between Fact and Opinion',"style"=> 'font-size:10px;color:#333;')); ?></th>
                     <th class="header"><?php echo $html->link('AP', '#', array('title' => 'Identifying Author\'s Purpose',"style"=> 'font-size:10px;color:#333;')); ?></th>
                      <th class="header"><?php echo $html->link('FL', '#', array('title' => 'Interpreting Figurative Language',"style"=> 'font-size:10px;color:#333')); ?></th>
                       <th class="header"><?php echo $html->link('RM', '#', array('title' => 'Distinguishing Between Real and Make-Believe',"style"=> 'font-size:10px;color:#333;')); ?></th>
				</tr>
              </thead>
              <tbody> 
