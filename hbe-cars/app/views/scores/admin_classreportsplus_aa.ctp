	...
	if ($.browser.webkit) {
       ...
       chart = new Highcharts.Chart({
         ...
         series: [{
			...
			<?php if ($glessontotal11 != 0) { $glesson11 = $MIGraphResp11 + $FDGraphResp11 + $POGraphResp11 + $WWGraphResp11 + $MGGraphResp11 + $FOGraphResp11; echo $glesson11total = round($glesson11 / $glessontotal11, 2) / 0.01; } else { echo $glesson11total = 0; } ?>,
			
			<?php if ($glessontotal12 != 0) { $glesson12 = $MIGraphResp12 + $FDGraphResp12 + $POGraphResp12 + $WWGraphResp12 + $MGGraphResp12 + $FOGraphResp12; echo $glesson12total = round($glesson12 / $glessontotal12, 2) / 0.01; } else { echo $glesson12total = 0; } ?>,
			
			<?php if ($glessontotal13 != 0) { $glesson13 = $MIGraphResp13 + $FDGraphResp13 + $POGraphResp13 + $WWGraphResp13 + $MGGraphResp13 + $FOGraphResp13; echo $glesson13total = round($glesson13 / $glessontotal13, 2) / 0.01; } else { echo $glesson13total = 0; } ?>,
			
			<?php if ($glessontotal14 != 0) { $glesson14 = $MIGraphResp14 + $FDGraphResp14 + $POGraphResp14 + $WWGraphResp14 + $MGGraphResp14 + $FOGraphResp14; echo $glesson14total = round($glesson14 / $glessontotal14, 2) / 0.01; } else { echo $glesson14total = 0; } ?>,
			
			<?php if ($glessontotal15 != 0) { $glesson15 = $MIGraphResp15 + $FDGraphResp15 + $POGraphResp15 + $WWGraphResp15 + $MGGraphResp15 + $FOGraphResp15; echo $glesson15total = round($glesson15 / $glessontotal15, 2) / 0.01; } else { echo $glesson15total = 0; } ?>,
     ...
     <?php 	$lessonid = $i;
		...
		<div class="tab_container">
            ...
            <tr> 
    				...
    				<th class="header"><?php echo $html->link('MI', '#', array('title' => 'Finding Main Idea', 'style' => 'font-size:11px;')); ?></th> 
