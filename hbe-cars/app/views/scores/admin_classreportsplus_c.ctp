	...
	if ($.browser.webkit) {
       ...
       chart = new Highcharts.Chart({
         ...
         series: [{
			...
			?>
            data: [<?php if ($glessontotal1 != 0) { $glesson1 = $MIGraphResp1 + $FDGraphResp1 + $USGraphResp1 + $CEGraphResp1 +  $CCGraphResp1 + $MPGraphResp1 + $WMGraphResp1 + $CIGraphResp1 + $FOGraphResp1 + $APGraphResp1 + $FLGraphResp1+ $RMGraphResp1; echo $glesson1total = round($glesson1 / $glessontotal1, 2) / 0.01; } else { echo $glesson1total = 0 ; } ?>,
			...
			<?php if ($glessontotal11 != 0) { $glesson11 = $MIGraphResp11 + $FDGraphResp11 + $USGraphResp11 + $CEGraphResp11 +  $CCGraphResp11 + $MPGraphResp11 + $WMGraphResp11 + $CIGraphResp11 + $FOGraphResp11 + $APGraphResp11 + $FLGraphResp11 + $RMGraphResp11; echo $glesson11total = round($glesson11 / $glessontotal11, 2) / 0.01; } else { echo $glesson11total = 0; } ?>,
			
			<?php if ($glessontotal12 != 0) { $glesson12 = $MIGraphResp12 + $FDGraphResp12 + $USGraphResp12 + $CEGraphResp12 +  $CCGraphResp12 + $MPGraphResp12 + $WMGraphResp12 + $CIGraphResp12 + $FOGraphResp12 + $APGraphResp12 + $FLGraphResp12 + $RMGraphResp12; echo $glesson12total = round($glesson12 / $glessontotal12, 2) / 0.01; } else { echo $glesson12total = 0; } ?>,
			
			<?php if ($glessontotal13 != 0) { $glesson13 = $MIGraphResp13 + $FDGraphResp13 + $USGraphResp13 + $CEGraphResp13 +  $CCGraphResp13 + $MPGraphResp13 + $WMGraphResp13 + $CIGraphResp13 + $FOGraphResp13 + $APGraphResp13 + $FLGraphResp13 + $RMGraphResp13; echo $glesson13total = round($glesson13 / $glessontotal13, 2) / 0.01; } else { echo $glesson13total = 0; } ?>,
			
			<?php if ($glessontotal14 != 0) { $glesson14 = $MIGraphResp14 + $FDGraphResp14 + $USGraphResp14 + $CEGraphResp14 +  $CCGraphResp14 + $MPGraphResp14 + $WMGraphResp14 + $CIGraphResp14 + $FOGraphResp14 + $APGraphResp14 + $FLGraphResp14 + $RMGraphResp14; echo $glesson14total = round($glesson14 / $glessontotal14, 2) / 0.01; } else { echo $glesson14total = 0; } ?>,
			
			<?php if ($glessontotal15 != 0) { $glesson15 = $MIGraphResp15 + $FDGraphResp15 + $USGraphResp15 + $CEGraphResp15 +  $CCGraphResp15 + $MPGraphResp15 + $WMGraphResp15 + $CIGraphResp15 + $FOGraphResp15 + $APGraphResp15 + $FLGraphResp15 + $RMGraphResp15; echo $glesson15total = round($glesson15 / $glessontotal15, 2) / 0.01; } else { echo $glesson15total = 0; } ?>,
