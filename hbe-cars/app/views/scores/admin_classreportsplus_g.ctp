	...
	if ($.browser.webkit) {
       ...
       chart = new Highcharts.Chart({
         ...
         series: [{
			...
			?>
            data: [<?php if ($glessontotal1 != 0) { $glesson1 = $MIGraphResp1 + $FDGraphResp1 + $USGraphResp1 + $CEGraphResp1 +  $CCGraphResp1 + $MPGraphResp1 + $WMGraphResp1 + $CIGraphResp1 + $FOGraphResp1 + $APGraphResp1 + $FLGraphResp1+ $SMGraphResp1; echo $glesson1total = round($glesson1 / $glessontotal1, 2) / 0.01; } else { echo $glesson1total = 0 ; } ?>,
			
			<?php if ($glessontotal2 != 0) { $glesson2 = $MIGraphResp2 + $FDGraphResp2 + $USGraphResp2 + $CEGraphResp2 +  $CCGraphResp2 + $MPGraphResp2 + $WMGraphResp2 + $CIGraphResp2 + $FOGraphResp2 + $APGraphResp2 + $FLGraphResp2+ $SMGraphResp2; echo $glesson2total = round($glesson2 / $glessontotal2, 2) / 0.01; } else { echo $glesson2total = 0; } ?>, 
			
			<?php if ($glessontotal3 != 0) { $glesson3 = $MIGraphResp3 + $FDGraphResp3 + $USGraphResp3 + $CEGraphResp3 +  $CCGraphResp3 + $MPGraphResp3 + $WMGraphResp3 + $CIGraphResp3 + $FOGraphResp3 + $APGraphResp3 + $FLGraphResp3+ $SMGraphResp3; echo $glesson3total = round($glesson3 / $glessontotal3, 2) / 0.01; } else { echo $glesson3total = 0; } ?>,
			
			<?php if ($glessontotal4 != 0) { $glesson4 = $MIGraphResp4 + $FDGraphResp4 + $USGraphResp4 + $CEGraphResp4 +  $CCGraphResp4 + $MPGraphResp4 + $WMGraphResp4 + $CIGraphResp4 + $FOGraphResp4 + $APGraphResp4 + $FLGraphResp4+ $SMGraphResp4; echo $glesson4total = round($glesson4 / $glessontotal4, 2) / 0.01; } else { echo $glesson4total = 0; } ?>,
			
			<?php if ($glessontotal5 != 0) { $glesson5 = $MIGraphResp5 + $FDGraphResp5 + $USGraphResp5 + $CEGraphResp5 +  $CCGraphResp5 + $MPGraphResp5 + $WMGraphResp5 + $CIGraphResp5 + $FOGraphResp5 + $APGraphResp5 + $FLGraphResp5+ $SMGraphResp5; echo $glesson5total = round($glesson5 / $glessontotal5, 2) / 0.01; } else { echo $glesson5total = 0; } ?>,
			
			<?php if ($glessontotal6 != 0) { $glesson6 = $MIGraphResp6 + $FDGraphResp6 + $USGraphResp6 + $CEGraphResp6 +  $CCGraphResp6 + $MPGraphResp6 + $WMGraphResp6 + $CIGraphResp6 + $FOGraphResp6 + $APGraphResp6 + $FLGraphResp6+ $SMGraphResp6; echo $glesson6total = round($glesson6 / $glessontotal6, 2) / 0.01; } else { echo $glesson6total = 0; } ?>,
			
			<?php if ($glessontotal7 != 0) { $glesson7 = $MIGraphResp7 + $FDGraphResp7 + $USGraphResp7 + $CEGraphResp7 +  $CCGraphResp7 + $MPGraphResp7 + $WMGraphResp7 + $CIGraphResp7 + $FOGraphResp7 + $APGraphResp7 + $FLGraphResp7 + $SMGraphResp7; echo $glesson7total = round($glesson7 / $glessontotal7, 2) / 0.01; } else { echo $glesson7total = 0; } ?>,
			
			<?php if ($glessontotal8 != 0) { $glesson8 = $MIGraphResp8 + $FDGraphResp8 + $USGraphResp8 + $CEGraphResp8 +  $CCGraphResp8 + $MPGraphResp8 + $WMGraphResp8 + $CIGraphResp8 + $FOGraphResp8 + $APGraphResp8 + $FLGraphResp8+ $SMGraphResp8; echo $glesson8total = round($glesson8 / $glessontotal8, 2) / 0.01; } else { echo $glesson8total = 0; } ?>,
			
			<?php if ($glessontotal9 != 0) { $glesson9 = $MIGraphResp9 + $FDGraphResp9 + $USGraphResp9 + $CEGraphResp9 +  $CCGraphResp9 + $MPGraphResp9 + $WMGraphResp9 + $CIGraphResp9 + $FOGraphResp9 + $APGraphResp9 + $FLGraphResp9 + $SMGraphResp9; echo $glesson9total = round($glesson9 / $glessontotal9, 2) / 0.01; } else { echo $glesson9total = 0; } ?>,
			
			<?php if ($glessontotal10 != 0) { $glesson10 = $MIGraphResp10 + $FDGraphResp10 + $USGraphResp10 + $CEGraphResp10 +  $CCGraphResp10 + $MPGraphResp10 + $WMGraphResp10 + $CIGraphResp10 + $FOGraphResp10 + $APGraphResp10 + $FLGraphResp10+ $SMGraphResp10; echo $glesson10total = round($glesson10 / $glessontotal10, 2) / 0.01; } else { echo $glesson10total = 0; } ?>,
			
			<?php if ($glessontotal11 != 0) { $glesson11 = $MIGraphResp11 + $FDGraphResp11 + $USGraphResp11 + $CEGraphResp11 +  $CCGraphResp11 + $MPGraphResp11 + $WMGraphResp11 + $CIGraphResp11 + $FOGraphResp11 + $APGraphResp11 + $FLGraphResp11 + $SMGraphResp11; echo $glesson11total = round($glesson11 / $glessontotal11, 2) / 0.01; } else { echo $glesson11total = 0; } ?>,
			
			<?php if ($glessontotal12 != 0) { $glesson12 = $MIGraphResp12 + $FDGraphResp12 + $USGraphResp12 + $CEGraphResp12 +  $CCGraphResp12 + $MPGraphResp12 + $WMGraphResp12 + $CIGraphResp12 + $FOGraphResp12 + $APGraphResp12 + $FLGraphResp12 + $SMGraphResp12; echo $glesson12total = round($glesson12 / $glessontotal12, 2) / 0.01; } else { echo $glesson12total = 0; } ?>,
			
			<?php if ($glessontotal13 != 0) { $glesson13 = $MIGraphResp13 + $FDGraphResp13 + $USGraphResp13 + $CEGraphResp13 +  $CCGraphResp13 + $MPGraphResp13 + $WMGraphResp13 + $CIGraphResp13 + $FOGraphResp13 + $APGraphResp13 + $FLGraphResp13 + $SMGraphResp13; echo $glesson13total = round($glesson13 / $glessontotal13, 2) / 0.01; } else { echo $glesson13total = 0; } ?>,
			
			<?php if ($glessontotal14 != 0) { $glesson14 = $MIGraphResp14 + $FDGraphResp14 + $USGraphResp14 + $CEGraphResp14 +  $CCGraphResp14 + $MPGraphResp14 + $WMGraphResp14 + $CIGraphResp14 + $FOGraphResp14 + $APGraphResp14 + $FLGraphResp14 + $SMGraphResp14; echo $glesson14total = round($glesson14 / $glessontotal14, 2) / 0.01; } else { echo $glesson14total = 0; } ?>,
			
			<?php if ($glessontotal15 != 0) { $glesson15 = $MIGraphResp15 + $FDGraphResp15 + $USGraphResp15 + $CEGraphResp15 +  $CCGraphResp15 + $MPGraphResp15 + $WMGraphResp15 + $CIGraphResp15 + $FOGraphResp15 + $APGraphResp15 + $FLGraphResp15 + $SMGraphResp15; echo $glesson15total = round($glesson15 / $glessontotal15, 2) / 0.01; } else { echo $glesson15total = 0; } ?>,
...
<h4 class="alert_info">Book G &nbsp;&nbsp; CARS &reg; Plus</h4>
<br/><br/>
     ...
     <?php 	$lessonid = $i;
		...
		<div class="tab_container">
            ...
            <tr> 
                    ...
                    <th class="header"><?php echo $html->link('SM', '#', array('title' => 'Summarising')); ?></th>
				</tr>
              </thead>
              <tbody> 
               <?php foreach ($customers as $customer) { ?>
				<tr> 
                    <td widtd="170" class="bold" align="right"><?php echo $customer['Customer']['customers_name']; ?></td> 
                     <td class="nobold" <?php (int)${$customer['Customer']['id'].'_count'.$i} = $customer['Score']['MI_pts'] + $customer['Score']['FD_pts'] + $customer['Score']['US_pts'] + $customer['Score']['CE_pts'] + $customer['Score']['CC_pts'] + $customer['Score']['MP_pts'] + $customer['Score']['WM_pts'] + $customer['Score']['CI_pts'] + $customer['Score']['FO_pts'] + $customer['Score']['AP_pts'] + $customer['Score']['FL_pts'] + $customer['Score']['SM_pts']; if ((int)${$customer['Customer']['id'].'_count'.$i} < 6) { echo "style='color:red;'"; } else { echo "style ='color:green'"; } ?>> <?php echo (int)${$customer['Customer']['id'].'_count'.$i} ?>
                    
                    </td> 
                    <td class="nobold"><?php $totalpercent = ($customer['Score']['MI_pts'] + $customer['Score']['FD_pts'] + $customer['Score']['US_pts'] + $customer['Score']['CE_pts'] + $customer['Score']['CC_pts'] + $customer['Score']['MP_pts'] + $customer['Score']['WM_pts'] + $customer['Score']['CI_pts'] + $customer['Score']['FO_pts'] + $customer['Score']['AP_pts'] + $customer['Score']['FL_pts'] + $customer['Score']['SM_pts']) / 12 * 100; if (round($totalpercent, 0) < 50) { echo "<span style='color:red;'>".round($totalpercent, 0)."%</span>"; } else { echo "<span style='color:green'>".round($totalpercent, 0)."%</span>"; } ?></td> 
                    ...
                    <td align="center" style<?php if($customer['Score']['SM_pts'] == 1) echo "='color:#000000'"; else echo "='color:red'" ?>>
					<?php if ($customer['Score']['SM_pts'] != 0) echo $customer['Score']['SM_pts']; else echo "X"; ?>
                    </td>
				</tr>  
                <?php  } ?>   
			</tbody> 
		...
		<div class="tab_container">
            ...
            <tr> 
                    ...
                    <th class="header"><?php echo $html->link('FO', '#', array('title' => 'Distinguishing Between Fact and Opinion','style'=> 'color:#333;')); ?></th>
                     <th class="header"><?php echo $html->link('AP', '#', array('title' => 'Identifying Author\'s Purpose','style'=> 'color:#333;')); ?></th>
                      <th class="header"><?php echo $html->link('FL', '#', array('title' => 'Interpreting Figurative Language','style'=> 'color:#333;')); ?></th>
                       <th class="header"><?php echo $html->link('SM', '#', array('title' => 'Summarising','style'=> 'color:#333;')); ?></th>
				</tr>
           </thead>
				<tr> 
                ...
                <tr> 
                    ...
                    <td class="nobold"><?php echo $noofresponse_SM; ?></td>
				</tr>
                <tr> 
                    ...
                    <td class="nobold"><?php echo $nocorrect_SM; ?></td>
				</tr>
                <tr> 
                    ...
                    <?php
					$totalSM = 0;
					if ($nocorrect_SM != 0 && $noofresponse_SM != 0) {
					$totalSM = $nocorrect_SM/$noofresponse_SM*100; } ?>
                    <td class="nobold" style<?php if($totalSM >= 50) echo "='color:green'"; else echo "='color:red'" ?>><?php  echo round($totalSM, 0)."%"; ?></td>
				</tr>              
			</tbody> 
 ...
 <?php
				...
				for($lesson_id = 1; $lesson_id <= 15; $lesson_id++) {
					...
					foreach ($score as $s) {
						...
						(int)${$s['Customer']['id'].'_total'} +=$s['Score']['MI_pts'] + $s['Score']['FD_pts'] + $s['Score']['US_pts'] + $s['Score']['CE_pts'] + $s['Score']['CC_pts'] + $s['Score']['MP_pts'] + $s['Score']['WM_pts'] + $s['Score']['CI_pts'] + $s['Score']['FO_pts'] + $s['Score']['AP_pts'] + $s['Score']['FL_pts'] + $s['Score']['SM_pts'];
					}
				}
			 ?>
