...
echo $html->link('Lesson 1', array('controller' => 'scores', 'action' => 'edit_carseries_aa_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns'));
} else {
echo $html->link('Lesson 1', array('controller' => 'scores', 'action' => 'edit_carseries_aa_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]));
} 
?> &nbsp; &bull; &nbsp;
<?php
echo $html->link('Lesson 2', array('controller' => 'scores', 'action' => 'edit_carseries_aa_2', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active')); 
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 3;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<header><h6>Lesson 2</h6></header>
            
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_aa_2'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
...
echo $form->input('FO', array('label' => false,'class'=>'ProductStatusPublish','validate'=>'required:true','options' => $options,'legend' => false,'separator' => '&nbsp;&nbsp;', 'type' => 'radio'));
 ?><label for="data[Score][FO]" class="error">This field is required.</label>
    ...
    <?php
	 echo $form->hidden('lesson', array('value' => 2));
