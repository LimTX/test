...
?> &nbsp; &bull; &nbsp;
<?php
echo $html->link('Lesson 3', array('controller' => 'scores', 'action' => 'edit_carseries_aa_3', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active'));    
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 4;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<header><h6>Lesson 3</h6></header>
            
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_aa_3'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
...
echo $form->input('FO', array('label' => false,'class'=>'ProductStatusPublish','validate'=>'required:true','options' => $options,'legend' => false,'separator' => '&nbsp;&nbsp;', 'type' => 'radio'));
 ?><label for="data[Score][FO]" class="error">This field is required.</label>
    ...
    <?php
	 echo $form->hidden('lesson', array('value' => 3));
