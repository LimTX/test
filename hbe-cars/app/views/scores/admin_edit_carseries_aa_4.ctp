...
?> &nbsp; &bull; &nbsp;
<?php
echo $html->link('Lesson 4', array('controller' => 'scores', 'action' => 'edit_carseries_aa_4', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active'));
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 5;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<header><h6>Lesson 4</h6></header>
            
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_aa_4'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
