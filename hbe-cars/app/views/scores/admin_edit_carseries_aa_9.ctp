...
?> &nbsp; &bull; &nbsp;
<?php
echo $html->link('Lesson 9', array('controller' => 'scores', 'action' => 'edit_carseries_aa_9', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active'));
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 10;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<header><h6>Lesson 9</h6></header>
            
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_aa_9'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
