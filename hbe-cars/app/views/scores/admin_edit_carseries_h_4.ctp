...
<?php echo $html->link('Lesson 1', array('controller' => 'scores', 'action' => 'edit_carseries_h_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state1)); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 2', array('controller' => 'scores', 'action' => 'edit_carseries_h_2', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state2)); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 3', array('controller' => 'scores', 'action' => 'edit_carseries_h_3', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state3)); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 4', array('controller' => 'scores', 'action' => 'edit_carseries_h_4', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state4)); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 5', array('controller' => 'scores', 'action' => 'edit_carseries_h_5', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state5)); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 6', array('controller' => 'scores', 'action' => 'edit_carseries_h_6', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state6)); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 7', array('controller' => 'scores', 'action' => 'edit_carseries_h_7', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state7)); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 8', array('controller' => 'scores', 'action' => 'edit_carseries_h_8', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state8)); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 9', array('controller' => 'scores', 'action' => 'edit_carseries_h_9', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state9)); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 10', array('controller' => 'scores', 'action' => 'edit_carseries_h_10', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => $state10)); ?>
</div>
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_h_'.$page_no.''),'class'=>'cmxform','id'=>'form2','type' => 'file'));
