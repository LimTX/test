...
<?php echo $html->link('Lesson 10', array('controller' => 'scores', 'action' => 'edit_carseries_k_10', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active')); ?>
</div>
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_k_10'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
