...
<?php echo $html->link('Lesson 2', array('controller' => 'scores', 'action' => 'edit_carseries_k_2', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active')); ?> &nbsp; &bull; &nbsp;
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_k_2'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
