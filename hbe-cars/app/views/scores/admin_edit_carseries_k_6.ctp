...
<?php echo $html->link('Lesson 6', array('controller' => 'scores', 'action' => 'edit_carseries_k_6', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('Lesson 7', array('controller' => 'scores', 'action' => 'edit_carseries_k_7', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2])); ?> &nbsp; &bull; &nbsp;
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_k_6'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
