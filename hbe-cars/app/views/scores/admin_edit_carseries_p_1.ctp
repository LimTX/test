...
echo $html->link('Lesson 1', array('controller' => 'scores', 'action' => 'edit_carseries_p_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active'));
?> &nbsp; &bull; &nbsp;
<?php 
$navlessonid = 2;
...
echo $html->link('Lesson 2', array('controller' => 'scores', 'action' => 'edit_carseries_p_2', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns')); 
} else {
echo $html->link('Lesson 2', array('controller' => 'scores', 'action' => 'edit_carseries_p_2', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2])); 
} ?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 3;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
if (count($checktest) == count($checkscore)) {
echo $html->link('Lesson 3', array('controller' => 'scores', 'action' => 'edit_carseries_p_3', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns')); 
} else {
echo $html->link('Lesson 3', array('controller' => 'scores', 'action' => 'edit_carseries_p_3', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]));	
} ?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 4;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
if (count($checktest) == count($checkscore)) {
echo $html->link('Lesson 4', array('controller' => 'scores', 'action' => 'edit_carseries_p_4', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns'));
} else {
echo $html->link('Lesson 4', array('controller' => 'scores', 'action' => 'edit_carseries_p_4', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]));
} ?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 5;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
if (count($checktest) == count($checkscore)) {
echo $html->link('Lesson 5', array('controller' => 'scores', 'action' => 'edit_carseries_p_5', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns'));
} else {
echo $html->link('Lesson 5', array('controller' => 'scores', 'action' => 'edit_carseries_p_5', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]));
} ?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 6;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
if (count($checktest) == count($checkscore)) {
echo $html->link('Lesson 6', array('controller' => 'scores', 'action' => 'edit_carseries_p_6', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns'));
} else {
echo $html->link('Lesson 6', array('controller' => 'scores', 'action' => 'edit_carseries_p_6', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]));
} ?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 7;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
if (count($checktest) == count($checkscore)) {
echo $html->link('Lesson 7', array('controller' => 'scores', 'action' => 'edit_carseries_p_7', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns'));
} else {
echo $html->link('Lesson 7', array('controller' => 'scores', 'action' => 'edit_carseries_p_7', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]));
} ?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 8;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
if (count($checktest) == count($checkscore)) {
echo $html->link('Lesson 8', array('controller' => 'scores', 'action' => 'edit_carseries_p_8', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns')); 
} else {
echo $html->link('Lesson 8', array('controller' => 'scores', 'action' => 'edit_carseries_p_8', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2])); 
}?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 9;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
if (count($checktest) == count($checkscore)) {
echo $html->link('Lesson 9', array('controller' => 'scores', 'action' => 'edit_carseries_p_9', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns'));
} else {
echo $html->link('Lesson 9', array('controller' => 'scores', 'action' => 'edit_carseries_p_9', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]));
}?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 10;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
if (count($checktest) == count($checkscore)) {
echo $html->link('Lesson 10', array('controller' => 'scores', 'action' => 'edit_carseries_p_10', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns'));
} else {
echo $html->link('Lesson 10', array('controller' => 'scores', 'action' => 'edit_carseries_p_10', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]));
}?>
</div>
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_p_1'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
?>	
