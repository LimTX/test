...
echo $html->link('Lesson 1', array('controller' => 'scores', 'action' => 'edit_carseries_p_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns'));
} else {
echo $html->link('Lesson 1', array('controller' => 'scores', 'action' => 'edit_carseries_p_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]));
} 
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 2;
...
?> &nbsp; &bull; &nbsp;
<?php
echo $html->link('Lesson 5', array('controller' => 'scores', 'action' => 'edit_carseries_p_5', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active'));
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 6;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_p_5'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
