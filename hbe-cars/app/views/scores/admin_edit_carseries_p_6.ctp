...
?> &nbsp; &bull; &nbsp;
<?php
echo $html->link('Lesson 6', array('controller' => 'scores', 'action' => 'edit_carseries_p_6', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active'));
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 7;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carseries_p_6'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
