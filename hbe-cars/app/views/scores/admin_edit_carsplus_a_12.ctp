...
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
if (count($checktest) == count($checkscore)) {
echo $html->link('BM 4', array('controller' => 'scores', 'action' => 'edit_carsplus_a_9', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'full-qns','title' => 'Benchmark 4'));
} else {
echo $html->link('BM 4', array('controller' => 'scores', 'action' => 'edit_carsplus_a_9', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('title' => 'Benchmark 4'));
}?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 10;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php 
echo $html->link('PT 2', array('controller' => 'scores', 'action' => 'edit_carsplus_a_12', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active', 'title' => 'Post Test 2'));
?>  &nbsp; &bull; &nbsp;
<?php
$navlessonid = 13;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<header><h6>Post Test 2</h6></header>
            
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_a_12'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
...
echo $form->input('RP', array('label' => false,'class'=>'ProductStatusPublish','validate'=>'required:true','options' => $options,'legend' => false,'separator' => '&nbsp;&nbsp;', 'type' => 'radio'));
 ?><label for="data[Score][RP]" class="error">This field is required.</label>
    ...
    <td>
     ...
     <?php
	 echo $form->hidden('lesson', array('value' => 12));
