...
<?php 
echo $html->link('PT 4', array('controller' => 'scores', 'action' => 'edit_carsplus_a_14', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active', 'title' => 'Post Test 4'));
?>  &nbsp; &bull; &nbsp;
<?php
$navlessonid =15;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_a_14'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
