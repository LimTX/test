...
?> &nbsp; &bull; &nbsp;
<?php
echo $html->link('PT 2', array('controller' => 'scores', 'action' => 'edit_carsplus_a_2', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active','title' => 'PreTest 2')); 
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 3;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_a_2'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
