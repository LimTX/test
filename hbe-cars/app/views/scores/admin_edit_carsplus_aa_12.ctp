...
<?php 
echo $html->link('PT 2', array('controller' => 'scores', 'action' => 'edit_carsplus_aa_12', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active', 'title' => 'Post Test 2'));
?>  &nbsp; &bull; &nbsp;
<?php
$navlessonid = 13;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_aa_12'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
