...
<?php
echo $html->link('PT 5', array('controller' => 'scores', 'action' => 'edit_carsplus_aa_5', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active','title' => 'PreTest 5')); 
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_aa_5'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
