...
<?php 
echo $html->link('BM 4', array('controller' => 'scores', 'action' => 'edit_carsplus_aa_9', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active', 'title' => 'Benchmark 4'));
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 10;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_aa_9'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
