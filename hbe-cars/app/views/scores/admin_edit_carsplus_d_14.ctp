...
<?php echo $html->link('PT 1', array('controller' => 'scores', 'action' => 'edit_carsplus_d_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state1,'title' => 'PreTest 1')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('PT 2', array('controller' => 'scores', 'action' => 'edit_carsplus_d_2', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state2,'title' => 'PreTest 2')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('PT 3', array('controller' => 'scores', 'action' => 'edit_carsplus_d_3', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state3,'title' => 'PreTest 3')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('PT 4', array('controller' => 'scores', 'action' => 'edit_carsplus_d_4', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state4,'title' => 'PreTest 4')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('PT 5', array('controller' => 'scores', 'action' => 'edit_carsplus_d_5', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state5,'title' => 'PreTest 5')); ?> &nbsp; <span style="color:#CCC;">&Iota;</span> &nbsp;
<?php echo $html->link('BM 1', array('controller' => 'scores', 'action' => 'edit_carsplus_d_6', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state6,'title' => 'Benchmark 1')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('BM 2', array('controller' => 'scores', 'action' => 'edit_carsplus_d_7', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state7,'title' => 'Benchmark 2')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('BM 3', array('controller' => 'scores', 'action' => 'edit_carsplus_d_8', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state8,'title' => 'Benchmark 3')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('BM 4', array('controller' => 'scores', 'action' => 'edit_carsplus_d_9', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]), array('id' => $state9,'title' => 'Benchmark 4')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('BM 5', array('controller' => 'scores', 'action' => 'edit_carsplus_d_10', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => $state10,'title' => 'Benchmark 5')); ?> &nbsp; <span style="color:#CCC;">&Iota;</span> &nbsp;
<?php echo $html->link('PT 1', array('controller' => 'scores', 'action' => 'edit_carsplus_d_11', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => $state11,'title' => 'Post Test 1')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('PT 2', array('controller' => 'scores', 'action' => 'edit_carsplus_d_12', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => $state12,'title' => 'Post Test 2')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('PT 3', array('controller' => 'scores', 'action' => 'edit_carsplus_d_13', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => $state13,'title' => 'Post Test 3')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('PT 4', array('controller' => 'scores', 'action' => 'edit_carsplus_d_14', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => $state14,'title' => 'Post Test 4')); ?> &nbsp; &bull; &nbsp;
<?php echo $html->link('PT 5', array('controller' => 'scores', 'action' => 'edit_carsplus_d_15', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => $state15,'title' => 'Post Test 5')); ?>
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_d_'.$page_no.''),'class'=>'cmxform','id'=>'form2','type' => 'file'));
