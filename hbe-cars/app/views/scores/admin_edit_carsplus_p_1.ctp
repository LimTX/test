...
echo $html->link('PT 1', array('controller' => 'scores', 'action' => 'edit_carsplus_p_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active', 'title' => 'PreTest 1'));
?> &nbsp; &bull; &nbsp;
<?php 
$navlessonid = 2;
...
<header><h6>Pretest 1</h6></header>
            
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_p_1'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
?>	
