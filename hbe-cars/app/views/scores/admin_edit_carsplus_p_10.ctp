...
<?php 
echo $html->link('BM 5', array('controller' => 'scores', 'action' => 'edit_carsplus_p_10', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active', 'title' => 'Benchmark 5'));
?>  &nbsp; <span style="color:#CCC">&Iota;</span> &nbsp;
<?php
$navlessonid = 11;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_p_10'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
