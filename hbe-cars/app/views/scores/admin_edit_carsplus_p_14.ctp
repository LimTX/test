...
<?php 
echo $html->link('PT 4', array('controller' => 'scores', 'action' => 'edit_carsplus_p_14', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active', 'title' => 'Post Test 4'));
?>  &nbsp; &bull; &nbsp;
<?php
$navlessonid =15;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<header><h6>Post Test 4</h6></header>
            
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_p_14'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
...
echo $form->input('FO', array('label' => false,'class'=>'ProductStatusPublish','validate'=>'required:true','options' => $options,'legend' => false,'separator' => '&nbsp;&nbsp;', 'type' => 'radio'));
 ?><label for="data[Score][FO]" class="error">This field is required.</label>
    ...
    <?php
	 echo $form->hidden('lesson', array('value' => 14));
