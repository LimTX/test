...
<?php 
echo $html->link('PT 5', array('controller' => 'scores', 'action' => 'edit_carsplus_p_15', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active', 'title' => 'Post Test 5'));
?>
</div>
<!------------------------------------------------------------------------------------------------
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_p_15'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
