...
<?php
echo $html->link('PT 4', array('controller' => 'scores', 'action' => 'edit_carsplus_p_4', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active','title' => 'PreTest 4')); 
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 5;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_p_4'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
