...
<?php
echo $html->link('PT 5', array('controller' => 'scores', 'action' => 'edit_carsplus_p_5', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active','title' => 'PreTest 5')); 
...
<header><h6>Pretest 5</h6></header>
            
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_p_5'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
