...
<?php 
echo $html->link('BM 3', array('controller' => 'scores', 'action' => 'edit_carsplus_p_8', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2]),array('id' => 'active', 'title' => 'Benchmark 3'));
?> &nbsp; &bull; &nbsp;
<?php
$navlessonid = 9;
$checkscore = $this->requestAction('/scores/checkscorecompletedlesson/'.$access_token."/".$navlessonid);
...
<?php
echo $form->create(null, array('url' => array('controller' => 'scores', 'action' => 'edit_carsplus_p_8'),'class'=>'cmxform','id'=>'form2','type' => 'file'));
