...
<?php echo $html->link('Lesson 1 - 5', array('controller' => 'scores', 'action' => 'reports_b', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-5'),array('style'=>$l15)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Lesson 6 - 10', array('controller' => 'scores', 'action' => 'reports_b', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'6-10'),array('style'=>$l610)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Lesson 1 - 10', array('controller' => 'scores', 'action' => 'reports_b', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-10'),array('style'=>$l110)); ?>
</div>
...
<article id="studentprofile" class="module width_quarter_report">
  ...
  <?php }  ?>
   ...
   <!-- <p class="test_label bold"><strong><?php // echo $studentID ?></strong></p> -->
    ...
    <?php echo $html->link('Edit Score Sheets', array('controller' => 'scores', 'action' => 'edit_carseries_b_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2])); ?>
    </p>
    </div>
