...
<?php echo $html->link('Lesson 1 - 5', array('controller' => 'scores', 'action' => 'reports_f', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-5'),array('style'=>$l15)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Lesson 6 - 10', array('controller' => 'scores', 'action' => 'reports_f', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'6-10'),array('style'=>$l610)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Lesson 1 - 10', array('controller' => 'scores', 'action' => 'reports_f', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-10'),array('style'=>$l110)); ?>
</div>
