...
<?php echo $html->link('Pretests', array('controller' => 'scores', 'action' => 'reportsplus_a', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-5'),array('style'=>$l15)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Benchmarks', array('controller' => 'scores', 'action' => 'reportsplus_a', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'6-10'),array('style'=>$l610)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Post Tests', array('controller' => 'scores', 'action' => 'reportsplus_a', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'11-15'),array('style'=>$l110)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Overall', array('controller' => 'scores', 'action' => 'reportsplus_a', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-15'),array('style'=>$l115)); ?>
</div>
...
$(function () {
    ...
    $(document).ready(function() {
       chart1 = new Highcharts.Chart({
         ...
         xAxis: {
            categories: ['MI', 'FD', 'US', 'CE', 'MP', 'WM', 'CI', 'RP'],
         },
         yAxis: {
         ...
         series: [{
            name: 'Strategy',
            data: [<?php echo $MI_pts ?>, <?php echo $FD_pts ?>, <?php echo $US_pts ?>, <?php echo $CE_pts ?>, <?php echo $MP_pts ?>, <?php echo $WM_pts ?>, <?php echo $CI_pts ?>, <?php echo $RP_pts ?>],
			threshold: 0,
         }]
      });});
});
...
<article class="module width_3_quarter_report mainidea_a_aa">
...
<table class="tablesorter" cellspacing="0"> 
            ...
            <tr>                     
            	<td style="padding:23px;">
                <p><strong>Reading Pictures</strong></p>
                </td>
                <td>
                <p><?php if ($RP_pts < $avg)
						 echo "<span style='color:red'>".$RP_pts."</span>";
						 else
						 echo "<span style='color:green'>".$RP_pts."</span>";
						  ?>  <?php echo $setting; ?></p>
                </td>
                <td>
                <p><?php 
						 $RP = round(($RP_pts / $graph) * 100,0);
						 if ($RP_pts < $avg)
						 echo "<span style='color:red'>".$RP."%</span>";
						 else
						 echo "<span style='color:green'>".$RP."%</span>";
...
<article id="studentprofile" class="module width_quarter_report">
  ...
  <?php }  ?>
   ...
   <!-- <p class="test_label bold"><strong><?php // echo $studentID ?></strong></p> -->
    ...
    <?php echo $html->link('Edit Score Sheets', array('controller' => 'scores', 'action' => 'edit_carsplus_a_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2])); ?>
    </p>
    </div>
...
<div id="container_graph_a_aa"></div>
<br clear="all" /> 
</article>
...
<article class="module width_3_quarter_report thirdidea_a_aa">
