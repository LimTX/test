...
<?php echo $html->link('Pretests', array('controller' => 'scores', 'action' => 'reportsplus_aa', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-5'),array('style'=>$l15)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Benchmarks', array('controller' => 'scores', 'action' => 'reportsplus_aa', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'6-10'),array('style'=>$l610)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Post Tests', array('controller' => 'scores', 'action' => 'reportsplus_aa', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'11-15'),array('style'=>$l110)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Overall', array('controller' => 'scores', 'action' => 'reportsplus_aa', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-15'),array('style'=>$l115)); ?>
</div>
...
<article id="studentprofile" class="module width_quarter_report">
  ...
  <?php }  ?>
   ...
   <!-- <p class="test_label bold"><strong><?php // echo $studentID ?></strong></p> -->
    ...
    <?php echo $html->link('Edit Score Sheets', array('controller' => 'scores', 'action' => 'edit_carsplus_aa_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2])); ?>
    </p>
    </div>
