...
<?php echo $html->link('Pretests', array('controller' => 'scores', 'action' => 'reportsplus_b', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-5'),array('style'=>$l15)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Benchmarks', array('controller' => 'scores', 'action' => 'reportsplus_b', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'6-10'),array('style'=>$l610)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Post Tests', array('controller' => 'scores', 'action' => 'reportsplus_b', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'11-15'),array('style'=>$l110)); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link('Overall', array('controller' => 'scores', 'action' => 'reportsplus_b', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2],'1-15'),array('style'=>$l115)); ?>
</div>
...
$(function () {
    ...
    $(document).ready(function() {
       chart1 = new Highcharts.Chart({
         ...
         xAxis: {
            categories: ['MI', 'FD', 'US', 'CE', 'CC', 'MP', 'WM', 'CI', 'FO','AP', 'FL', 'RM'],
         },
         yAxis: {
         ...
         series: [{
            name: 'Strategy',
            data: [<?php echo $MI_pts ?>, <?php echo $FD_pts ?>, <?php echo $US_pts ?>, <?php echo $CE_pts ?>, <?php echo $CC_pts ?>, <?php echo $MP_pts ?>, <?php echo $WM_pts ?>, <?php echo $CI_pts ?>, <?php echo $FO_pts ?>, <?php echo $AP_pts ?>, <?php echo $FL_pts ?>, <?php echo $RM_pts ?>],
			threshold: 0,
         }]
      });});
});
...
<table class="tablesorter" cellspacing="0"> 
            ...
            <tr>                     
            	<td style="padding:23px;">
                <p><strong>Distinguishing Between Real and Make-Believe </strong></p>
                </td>
                <td>
                <p><?php if ($RM_pts < $avg)
						 echo "<span style='color:red'>".$RM_pts."</span>";
						 else
						 echo "<span style='color:green'>".$RM_pts."</span>";
						  ?>  <?php echo $setting; ?></p>
                </td>
                <td>
                <p><?php 
						 $RM = round(($RM_pts / $graph) * 100,0);
						 if ($RM_pts < $avg)
						 echo "<span style='color:red'>".$RM."%</span>";
						 else
						 echo "<span style='color:green'>".$RM."%</span>";
...
<article id="studentprofile" class="module width_quarter_report">
  ...
  <?php }  ?>
   ...
   <!-- <p class="test_label bold"><strong><?php // echo $studentID ?></strong></p> -->
    ...
    <?php echo $html->link('Edit Score Sheets', array('controller' => 'scores', 'action' => 'edit_carsplus_b_1', $this->params['pass'][0],$this->params['pass'][1],$this->params['pass'][2])); ?>
    </p>
    </div>
...
<td width="50%" style="text-align:center;">
	...
	?></p>
    <p><?php if ($RM_pts >= 8)
	echo "Distinguishing Between Real and Make-Believe"."<br/><br/>";
	else
	echo "";
	?></p>
</td>
