...
$(document).ready(
 ...
 $(document).ready(
	...
	function populateSchoolList(classrooms) {
		...
		$('#TestCustomersTeacherId').html(cheroptions);
		$('#TestClassroomId').html(options);
	}
	...
	function populateTeacherList(teachers) {
		...
		$('#TestCustomersTeacherId').html(options);
	}