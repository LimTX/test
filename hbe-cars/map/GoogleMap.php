	...
	*/
    ...
    function getMap() {
        ...
        if(strlen($this->width) > 0 && strlen($this->height) > 0) {
            $_output .= sprintf('document.write(\'<div id="%s" style="width: %s; margin-left:10px; height: %s;"><\/div>\');',$this->map_id,$this->width,$this->height) . "\n";
        } else {
            $_output .= sprintf('document.write(\'<div id="%s" style=""><\/div>\');',$this->map_id) . "\n";     
        }
        //$_output .= '}';
